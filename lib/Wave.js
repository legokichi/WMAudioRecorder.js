...
function Wave(channel,    // @arg Number - n channel
              ...
              int16ary) { // @arg Int16Array - 16bit nCh PCM raw data
                          // @ret Wave
//{@dev
    $args(Wave, arguments);
//}@dev
...
function Wave_toBlob() { // @ret Blob
    return new Blob([this["buffer"]], {"type": "audio/wav"});
}

function Wave_toURL() { // @ret BlobURLString
    return URL["createObjectURL"](this["toBlob"]());
}

function Wave_toAudio() { // @ret HTMLAudioElement
    var audio;
...
// --- exports ---------------------------------------------
global["WMRecord_" in global ? "WMRecord_" : "WMRecord"]["Wave"] = Wave; // switch module. http://git.io/Minify
